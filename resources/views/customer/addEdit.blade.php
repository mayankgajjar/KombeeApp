...
<div class="container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <input type="hidden" name="id" id="customer_id" value="{{ $id }}" />
...
<script>
    ...
    function editCustomer(id) {
        fetch(siteUrl + 'api/admin/customer/' + id, {
            method: 'GET',
            headers: {
                'Authorization': 'Bearer ' + token, // Bearer token in header
                'Accept': 'application/json', // Accept JSON response
        ...
        .then(res => {
            if (res.success) {
                ...
                $(".panel-heading").html("Edit Customer");
                setTimeout(function () {
    ...
    function SaveCustomer() {
        ...
        if (id == 0) {
            var url = siteUrl + 'api/admin/customer';
            var method = "POST";
        } else {
            var url = siteUrl + 'api/admin/customer/'+id;
            var method = "PUT";
        }
